...
1. Décompresser entièrement `TaoConnect-v0.4-source.zip`.
2. Ouvrir le dossier `TaoConnect-v0.4` obtenu.
...
6. Après validation, télécharger l’artifact **TaoConnect-v0.4-debug.apk**.
7. Installer `TaoConnect-v0.4-debug.apk` sur le téléphone Android.
