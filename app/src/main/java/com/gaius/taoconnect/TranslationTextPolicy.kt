...
internal object TranslationTextPolicy {
    ...
    /** Corrige quelques tournures littérales fréquentes sans inventer de sens. */
    private fun polishFrench(text: String): String =
        text.replace(Regex("\\best coton\\b", RegexOption.IGNORE_CASE), "est en coton")
